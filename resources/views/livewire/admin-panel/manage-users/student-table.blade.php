                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div style="margin-left: 1rem">
                            <button style="width: 9rem" type="button" class="btn btn-block bg-gradient-primary"  wire:click="createStudent"><i class="fa fa-plus-circle"></i> Add Student</button>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="StudentTable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th data-toggle="tooltip" data-placement="top" title="Student ID">Student ID</th>
                                        <th>Name</th>
                                        <th>Email</th>
                                        <th>Status</th>
                                        <th>Last Seen</th>
    ...
    <div wire.ignore.self class="modal fade" id="StudentModal" role="dialog" aria-labelledby="StudentModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <livewire:admin-panel.manage-users.student-form />
            </div>
            <!-- /.modal-content -->
        </div>
        <!-- /.modal-dialog -->
...
@section('custom_script')
    @include('layouts.scripts.admin-student-table-scripts'); 
@endsection