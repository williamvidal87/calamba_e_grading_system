<div>
    <div class="card card-primary">
        <div class="card-header">
            ...
            <button type="button" class="close" wire:click="closeTeacherForm" id="button-reset">
        ...
        <form wire:submit.prevent="store" enctype="multipart/form-data">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" wire:click="closeTeacherForm">Close</button>
